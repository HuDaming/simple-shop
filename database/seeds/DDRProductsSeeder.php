    ...
    public function run()
    {
        $productData = [
            [
                ...
                "cover"       => "https://img.alicdn.com/bao/uploaded/i2/TB1iqkaLVXXXXagXXXXObG1FpXX_091208.jpg_b.jpg",
                "price"       => "399.00",
                "skus"        => [
            ...
            [
                ...
                "cover"       => "https://img.alicdn.com/bao/uploaded/i4/TB1URYGHVXXXXXsaXXXtD198VXX_032444.jpg_b.jpg",
                "price"       => "489.00",
                "skus"        => [
            ...
            [
                ...
                "cover"       => "https://img.alicdn.com/bao/uploaded/i5/TB1up8DGXXXXXaAaXXXszso_pXX_060025.jpg_b.jpg",
                "price"       => "239.00",
                "skus"        => [
            ...
            [
                ...
                "cover"       => "https://img.alicdn.com/bao/uploaded/i3/TB1oIQJKVXXXXc3XXXXa0s37FXX_013328.jpg_b.jpg",
                "price"       => "489.00",
                "skus"        => [
            ...
            [
                ...
                "cover"       => "https://img.alicdn.com/bao/uploaded/i2/TB1SynxMVXXXXaVXFXX_qyp.VXX_111729.jpg_b.jpg",
                "price"       => "359.00",
                "skus"        => [
            ...
            [
                ...
                "cover"       => "https://img.alicdn.com/bao/uploaded/i8/TB1nkDwATJYBeNjy1zelIqhzVXa_020604.jpg_b.jpg",
                "price"       => "539.00",
                "skus"        => [
        ...
        foreach ($productData as $item) {
            // 创建一个新商品
            $product = new Product(array_merge(array_only($item, [
                'title',
                'long_title',
                'description',
                'cover',
